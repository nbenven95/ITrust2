...
public class FoodDiaryEntryTest {
    ...
    public void testDiaryEntry () {
        final FoodDiaryEntry entry = new FoodDiaryEntry();
        ...
        def.setDate( String.valueOf( cal.getTimeInMillis() ) );
        def.setMealType( MealType.Lunch.toString() );
        ...
        def.setFiber( "40" );
        def.setProtein( "10" );
        final FoodDiaryEntry entry2 = new FoodDiaryEntry( def );
    ...
    public void testDiaryEntryInvalid () {
        ...
        try {
            final Calendar cal = new GregorianCalendar( 3000, 9, 3 );
    ...
    public void testGetByPatient () {
        ...
        final FoodDiaryEntry entry2 = new FoodDiaryEntry();
